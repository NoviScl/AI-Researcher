...
if __name__ == "__main__": 
    ...
    parser.add_argument('--cache_dir', type=str, default="../cache_results_claude_may/experiment_plans_5k_dedup", help='cache file name')
    parser.add_argument('--cache_name', type=str, default="bias_prompting_method_merged", help='cache file name')
    ...
    for filename in filenames:
        ...
        if "full_experiment_plan" in paper and isinstance(paper["full_experiment_plan"], dict):
            try:
                all_ideas.append(format_plan_json(paper["full_experiment_plan"], indent_level=0, skip_test_cases=True, skip_fallback=True))
            except:
                continue
